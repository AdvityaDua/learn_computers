...
export default function LoginPage() {
  ...
  const onGoogleLogin = async () => {
    ...
    try {
      ...
      setError(submitError instanceof Error ? submitError.message : "Unable to login with Google right now.");
    } finally {
    ...
    <div className="theme-page min-h-screen">
      ...
      <main className="auth-shell mx-auto grid w-full max-w-6xl items-center px-6 py-12 md:px-10">
        <section className="mx-auto w-full max-w-md auth-card p-6 md:p-8">
          ...
          <p className="section-subtitle">Sign in to continue your learning journey and track your progress.</p>
